...
public class RegularMember extends Member {
    protected double memberShipCost=15;
    protected String registrationDate, expirationDate;

 

    public RegularMember(String registrationDate, String expirationDate, String memberShipType, String paymentType, double paymentAmount, String name, String phoneNumber, String adress) {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 23 * hash + (int) (Double.doubleToLongBits(this.memberShipCost) ^ (Double.doubleToLongBits(this.memberShipCost) >>> 32));
        hash = 23 * hash + Objects.hashCode(this.registrationDate);
        hash = 23 * hash + Objects.hashCode(this.expirationDate);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final RegularMember other = (RegularMember) obj;
